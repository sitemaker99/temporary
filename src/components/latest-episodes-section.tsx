...
const LatestEpisodesAnime = (props: Props) => {
  ...
  return (
    <Container className="flex flex-col gap-5 py-8 items-center lg:items-start lg:mt-[-10.125rem] z-20 ">
      <h5 className="text-xl sm:text-2xl font-bold section-header">Recent Releases</h5>
